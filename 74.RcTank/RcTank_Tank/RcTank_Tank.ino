...
void setup() {
  ...
  Timer1.initialize(TIMER_INT);                  // Initialise timer 1
...
void loop(void) {
  ...
  if ( role == role_pong_back ) {
    ...
    while ( radio.available(&pipeNo)) {            // Read all available payloads
      ...
      if( gotByte&RIGHT_FORWARD_MASK )
      {
        printf("RIGHT_FORWARD HIGH \n\r");
        digitalWrite(RIGHT_FORWARD, HIGH);
      }else{
        printf("RIGHT_FORWARD LOW \n\r");
        digitalWrite(RIGHT_FORWARD, LOW);
      }

      if( gotByte&RIGHT_REAR_MASK )
      {
        printf("RIGHT_REAR HIGH \n\r");
        digitalWrite(RIGHT_REAR, HIGH);
      }else{
        printf("RIGHT_REAR LOW \n\r");
        digitalWrite(RIGHT_REAR, LOW);
      }

      if( gotByte&LEFT_FORWARD_MASK )
      {
        printf("LEFT_FORWARD HIGH \n\r");
        digitalWrite(LEFT_FORWARD, HIGH);
      }else{
        printf("LEFT_FORWARD LOW \n\r");
        digitalWrite(LEFT_FORWARD, LOW);
      }

      if( gotByte&LEFT_REAR_MASK )
      {
        printf("LEFT_REAR HIGH \n\r");
        digitalWrite(LEFT_REAR, HIGH);
      }else{
        printf("LEFT_REAR LOW \n\r");
        digitalWrite(LEFT_REAR, LOW);
      }
      printf("\n\r");
      
    }  // end of 'while ( radio.available(&pipeNo))'
  } // end of 'if ( role == role_pong_back )'
